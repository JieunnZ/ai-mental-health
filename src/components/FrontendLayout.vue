  ...
  <div class="frontend-layout">
    <div class="navbar-container">
      <div class="brand-section">
        <el-image style="width: 50;height:50px;" :src="iconUrl" alt="品牌logo" class="brand-logo"></el-image>
      ...
      <div class="nav-section">
        ...
        <el-button size="medium" class="logout-btn" @click="handleLogout"  v-if="isLoggedIn">退出登录</el-button>
        <template v-else>
