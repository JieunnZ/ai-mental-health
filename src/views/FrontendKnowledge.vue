<script setup>
import { getKnowledgeListAPI } from "@/apis/frontend.js"
import { ref } from 'vue'
...
const getRecommendList = () => {
  getKnowledgeListAPI(params.value).then((res) => {
...
const getArticleList = () => {
  ...
  getKnowledgeListAPI(articleParams).then((res) => {
