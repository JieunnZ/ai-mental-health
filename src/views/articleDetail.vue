<script setup>
import { getKnowledgeDetailAPI } from '@/apis/frontend'
import { ref } from 'vue'
...
const iconBookUrl=new URL('@/assets/images/book.png',import.meta.url).href
//  格式化文章内容
...
const getArticleDetail = async () => {
  const res = await getKnowledgeDetailAPI(props.id)
  ...
  <div class="articleDetail-container">
    <div class="header-section">
      <div class="header-content">
        <el-image :src="iconBookUrl" style="width: 60px;height: 60px;"
        />
       <h1>知识文章详情</h1>
    </div>
    </div>
      ...
      <div class="diary-card">
        ...
        <div class="diary-card">
          ...
          <div class="tags-content" v-if="articleDetail.tagArray && articleDetail.tagArray.length">
            ...
            <div class="tags-list">
              <el-tag class="tag-item" v-for="tag in articleDetail.tagArray" :key="tag" type="info" effect="light">{{tag}}</el-tag>
            </div>
          </div>
        </div>
      </div>
