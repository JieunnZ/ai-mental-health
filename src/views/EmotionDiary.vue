...
import { addEmotionDiaryAPI } from "@/apis/frontend.js"
...
const submit = () => {
  ...
  addEmotionDiaryAPI(diaryForm.value).then(() => {
...
<div class="emotionDiary-container">
  <div class="header-section">
    <div class="header-content">
      <el-image :src="iconLikeUrl" style="width: 60px;height: 60px;"
      />
      <h1>情绪日记</h1>
    </div>
  </div>
  <div class="content">
    ...
    <div class="diary-card">
      ...
      <div class="section">
        ...
        <div class="rate">
          <el-rate v-model="diaryForm.moodScore" :texts="emotionStatus" :max="10" size="large" show-text></el-rate>
        </div>
      </div>
    </div>
    <!-- 主要情绪 -->
    ...
    <div class="diary-card">
      ...
      <div class="detail-form">
        ...
        <div class="form-group">
          <div class="form-label">情绪触发情绪</div>
          <el-input v-model="diaryForm.emotionTriggers" placeholder="今天什么事影响了您的情绪?" type="textarea" :rows="3" maxLength="1000" show-word-limit></el-input>
        </div>
        <!-- 今日感想 -->
        <div class="form-group">
          <div class="form-label">今日感想</div>
          <el-input v-model="diaryForm.diaryContent" placeholder="写下您今天的想法\感受或发生的有趣的事情..." type="textarea" :rows="5" maxLength="2000" show-word-limit></el-input>
        </div>
        <!-- 生活质量 -->
